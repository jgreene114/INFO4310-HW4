...
const loadData = async function () {
    var hubData = await d3.csv("data/Biketown Cleaned Data/hubs.csv")
    var tripData = await d3.csv("data/Biketown Cleaned Data/trips.csv")
    ...
    // question: try removing zoom hide?
